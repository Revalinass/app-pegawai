...
@section('page-title', 'Tambah Cuti')
@section('page-subtitle', 'Input data cuti pegawai')
...
<div class="mb-6">
    <div class="flex items-center gap-3 mb-2">
        ...
        <div>
            <h2 class="text-xl font-bold text-gray-800">Ajukan Cuti Baru</h2>
            <p class="text-sm text-gray-500 mt-1">Lengkapi form di bawah untuk mengajukan cuti</p>
        </div>
    </div>
</div>
