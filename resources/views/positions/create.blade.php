...
@section('page-title', 'Tambah Posisi')
@section('page-subtitle', 'Input data posisi baru')
...
<div class="mb-6">
    <div class="flex items-center gap-3 mb-2">
        ...
        <div>
            <h2 class="text-xl font-bold text-gray-800">Tambah Posisi Baru</h2>
            <p class="text-sm text-gray-500 mt-1">Lengkapi form di bawah untuk menambah posisi</p>
        </div>
    </div>
</div>
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea id="deskripsi" 
                          name="deskripsi" 
                          rows="4"
                          class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-rose focus:border-rose transition-all @error('deskripsi') border-red-500 @enderror" 
                          placeholder="Deskripsi posisi (opsional)">{{ old('deskripsi') }}</textarea>
                @error('deskripsi')
                    <p class="mt-1 text-sm text-red-500 flex items-center gap-1">
                        <i data-lucide="alert-circle" class="w-4 h-4"></i>
                        {{ $message }}
